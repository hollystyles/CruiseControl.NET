    ...
    <xsl:template match="/">
        ...
        <table class="table">
            ...
            <xsl:if test="/cruisecontrol/exception">
                <tr><td class="header-title" colspan="2"><span class="label Red">BUILD EXCEPTION</span></td></tr>
                <tr>
            ...
            <xsl:if test="/cruisecontrol/build/@error">
                <tr><td class="header-title" colspan="2"><span class="label Red">BUILD FAILED</span></td></tr>
            </xsl:if>
            
            <xsl:if test="not (/cruisecontrol/build/@error) and not (/cruisecontrol/exception)">
                <tr><td class="header-title" colspan="2"><span class="label Green">BUILD SUCCESSFUL</span></td></tr>
            </xsl:if>
